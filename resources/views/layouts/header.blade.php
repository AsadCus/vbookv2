    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a class="d-lg-none">
                ...
                <img alt="Logo" src="/gambar/company/{{ auth()->user()->company->logo }}" class="h-30px" />
                @else
                <img alt="Logo" src="{{ asset('gambar/logo-vbook.png') }}" class="h-30px" />
                @endif
            </a>
            ...
            <div class="d-flex align-items-stretch justify-self-end flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-30px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        @if (auth()->user()->role_id == 1)
                        <img alt="Logo" src="{{ asset('gambar/logo-vbook.png') }}" alt="user" class="w-40px h-40px" style="object-fit: contain" />
                        @elseif (isset(auth()->user()->company->logo))
                        <img alt="Logo" src="/gambar/company/{{ auth()->user()->company->logo }}" alt="user" class="w-40px h-40px" style="object-fit: contain" />
                        @else
                        <img alt="Logo" src="{{ asset('gambar/logo-vbook.png') }}" alt="user" class="w-40px h-40px" style="object-fit: contain" />
                        @endif
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-30px me-5">
                                    @if (auth()->user()->role_id == 1)
                                    <img alt="Logo" src="{{ asset('gambar/logo-vbook.png') }}" class="w-40px h-40px" style="object-fit: contain" />
                                    @elseif (isset(auth()->user()->company->logo))
                                    <img alt="Logo" src="/gambar/company/{{ auth()->user()->company->logo }}" class="w-40px h-40px" style="object-fit: contain" />
                                    @else
                                    <img alt="Logo" src="{{ asset('gambar/logo-vbook.png') }}" class="w-40px h-40px" style="object-fit: contain" />
                                    @endif
                                </div>
                        ...
                        <div class="menu-item px-5">
                            ...
                            <a href="{{ route('pantry.logout') }}" class="menu-link px-5">Sign Out</a>
                            @else
