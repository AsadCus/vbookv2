                        ...
                        style="background-color:#2F4F4F">
                            ...
                            <h3 class="card-title align-items-start flex-column text-white pt-15">
                                ...
                                <div class="fs-4 text-white">
                                    <span class="opacity-75">Welcome to the Dashboard SUPERADMIN V-BOOK</span>
                                ...
                                <div class="row g-3 g-lg-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-bold fs-6">Client Active</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                            ...
                                            <div class="m-0">
                                                <!--begin::Number-->
                                                <span class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">{{ $countCompanyNonActive }}</span>
                                                <!--end::Number-->
                                                <!--begin::Desc-->
                                                <span class="text-gray-500 fw-bold fs-6">Client Non Active</span>
                                                <!--end::Desc-->
                                            </div>
                                            <!--end::Stats-->
                                        </div>
