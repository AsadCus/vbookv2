                            ...
                            <tr>
                                <td style="text-align:center; background: rgba(0, 0, 0, .8); padding: 2.5em;">
                                    <div style="font-size: 18px;margin-top: 0;line-height: 1.4; color: rgba(255,255,255,.8);">
                                        <img src="{{ env('APP_URL') }}/gambar/waktu.png" alt="" style="width: 50px; max-width: 600px; height: auto; margin: auto; display: block;">
                                        <h2>Reminder Meeting</h2>
                                        <p style="font-size: 14px;margin-top: 0;line-height: 1.4; color: rgba(255,255,255,.8);">Meeting <strong>{{$data['title']}}</strong>  Akan segera dimulai {{$data['remainder_at']}} menit lagi.</p>
                                        ...
                                        <tr>
                                                ...
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            ...
                                                            <img src="{{ env('APP_URL') }}/gambar/selesai.png" alt="" style="width: 60px; max-width: 600px; height: auto; margin: auto; display: block;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 0;text-align: center;">
                                                            <h4><a href="{{ env('APP_URL') }}/confirmation/present?bookingId={{$data['booking_id']}}&email={{$data['email']}}"><button style="padding: 10px 15px; border-radius: 30px; background: #f3a333; color: #ffffff;">Hadir</button> </a></h4>
                                            ...
                                            <td valign="top" width="50%" style="padding-top: 20px;">
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        <td style="text-align: center;">
                                                            <img src="{{ env('APP_URL') }}/gambar/batal.png" alt="" style="width: 60px; max-width: 600px; height: auto; margin: auto; display: block;">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding: 10px 10px 0;text-align: center;">

                                                         <h4><a href="{{ env('APP_URL') }}/confirmation/not-present?bookingId={{$data['booking_id']}}&email={{$data['email']}}"><button style="padding: 10px 15px; border-radius: 30px; background: #f3a333; color: #ffffff;">Tidak</button> </a></h4>
