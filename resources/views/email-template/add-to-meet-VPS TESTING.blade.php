...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;">
    <center style="width: 100%; background-color: #f1f1f1;">
      ...
      "><span style="mso-text-raise: 15pt">
                                                        <img src="https://testing.vbooksystem.com/gambar/google-calendar.png" alt="" width="20px" />&nbsp; Tambahkan ke Google Calendar</span></a>
        ...
        box-shadow: 0 3px 6px rgba(0, 0, 0, 0.2);
      "><span style="mso-text-raise: 15pt">
                                                        <img src="https://testing.vbooksystem.com/gambar/365-logo.jpg" alt="" width="20px" />&nbsp; Tambahkan ke Office365 Calendar</span></a>
        ...
        box-shadow: 0 3px 6px rgba(0, 0, 0, 0.2);
      "><span style="mso-text-raise: 15pt">
                                                        <img src="https://testing.vbooksystem.com/gambar/outlook-calendar.png" alt="" width="22px" />&nbsp; Tambahkan ke Outlook Calendar</span></a>
                                                <br>
                                            </td>
                                        </tr>
                                    </table>
