                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center" id="kt_header_wrapper">
                                ...
                                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                                    <!--begin::Heading-->
                                    <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">Detail Booking Room</h1>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form @submit.prevent="submitFormCancel" enctype="multipart/form-data" id="kt_ecommerce_add_product_form">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cancel Booking</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        Apakah Anda yakin untuk cancel booking ini ?
                                    </div>
                        ...
                        <div class="container-xxl" id="kt_content_container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h2 class="card-title fw-bolder">Detail - {{ $bookingEvent->title }} </h2>
                                    <div class="card-toolbar">
                                        <a href="/guest-booking/{{ $bookingEvent->id }}/edit">
                                            <button class="btn btn-flex btn-primary btn-sm me-2">
                                        ...
                                        <button class="btn btn-flex btn-warning btn-sm me-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <span class="svg-icon svg-icon-2">
                                        ...
                                        <button class="btn btn-danger btn-sm" @click.prevent="deleteRecord(bookingEvent.id)">
                                    ...
                                    <div class="col-12 mb-4">
                                        <table>
                                            <tr>
                                                ...
                                                <td>: &nbsp; <b>{{ $bookingEvent->title }}</b></td>
                                            </tr>

                                            <tr>
                                                <td style="width: 50%;">Status</td>
                                                <td>: &nbsp; <b>{{ $bookingEvent->status_booking }}</b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>: &nbsp; <b>{{ $bookingEvent->start_date }}</b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>: &nbsp; <b>{{ $bookingEvent->end_date }}</b></td>
                                            </tr>
...
<script>
    const bookingEvent = <?php echo Illuminate\Support\Js::from($bookingEvent) ?>;
    let app = new Vue({
        el: '#app',
        data: {
            bookingEvent,
        ...
        methods: {
            ...
            sendDataCancel: function() {
                let vm = this;
                vm.loading = true;
                axios.post('/guest-booking/{{ $bookingEvent->id }}/cancel', {
                        guest_access: this.guestAccess,
            ...
            deleteRecord: function(id) {
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios.delete('/guest-booking/' + id)
                            .then(function(response) {
