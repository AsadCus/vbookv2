                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center" id="kt_header_wrapper">
                                ...
                                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                                    <!--begin::Heading-->
                                    <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">Edit Booking Room</h1>
                        ...
                        <div class="container-xxl" id="kt_content_container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h2 class="card-title fw-bolder">Edit Event </h2>
                                ...
                                <div class="card-body">
                                    <form @submit.prevent="submitForm" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12 mb-4">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="datetime-local" class="form-control" v-model="start_date"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="datetime-local" class="form-control" v-model="end_date"></td>
                                                </tr>
                                        ...
                                        <div class="text-end">
                                            <a href="/booking" class="btn btn-secondary">Cancel</a href="/booking">
...
<script>
    let app = new Vue({
        ...
        data: {
            ...
            statusBooking: '{{ $bookingEvent->status_booking }}',
            start_date: '{{ $bookingEvent->start_date }}',
            end_date: '{{ $bookingEvent->end_date }}',
            loading: false,
        },
        methods: {
            ...
            sendData: function() {
                let vm = this;
                vm.loading = true;
                axios.post('/guest-booking/{{ $bookingEvent->id }}/update', {
                        title: this.title,
