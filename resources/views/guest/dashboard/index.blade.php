                                ...
                                <div class="rounded border border-dashed border-primary py-4 px-6 mb-5">
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-1">
                                                <div class="fs-6 fw-bold text-gray-800 fw-bold mb-0 me-1">{{ $booking->title }}</div>
                                                <!-- <span class="badge" style="background:{{ $booking->room->color_code ?? '#32a852' }};">-</span> -->
                                                &nbsp; &nbsp; &nbsp;
                                                <a href="/booking/{{ $booking->id }}/detail" class="btn btn-sm btn-primary">
                                            ...
                                            <br>
                                            <vr style="border-left:4px solid {{ $booking->room->color_code ?? '#32a852' }}; height:60px;">
