                                ...
                                <div class="card-body">
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="text-end mb-4">
                                            <a href="/recurring-booking/search" class="btn btn-primary">Create Recurrence</a>
                                        </div>
                                        <!--begin::Table-->
                                        <table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                <!--begin::Table row-->
                                                <tr v-for="(recurrences, index) in recurrence">

                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ index +1 }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ recurrences.title }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ recurrences.division.name }}</span>
                                                    </td>

                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ recurrences.room.name }}</span>
                                                    </td>


                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ recurrences.start_date }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="fw-bolder ms-3">@{{ recurrences.end_date }}</span>
                                                    </td>

                                                    <td class="text-center">
                                                        <button class="btn btn-danger btn-sm" @click.prevent="deleteRecord(recurrences.id)">
...
<script>
    const recurrence = <?php echo Illuminate\Support\Js::from($recurrence) ?>;
    let app = new Vue({
        el: '#app',
        data: {
            recurrence,
        ...
        methods: {
            deleteRecord: function(id) {
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios.delete('/recurring-booking/' + id)
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: 'Recurring booking Barang Berhasil Dihapus',
                        }).then((result) => {
                            if (result.isConfirmed) {
