...
<head>
    ...
    <title>Detail History Booking</title>
    <meta charset="utf-8" />
                        ...
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            ...
                            <div class="d-flex align-items-center" id="kt_header_wrapper">
                                ...
                                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_wrapper'}">
                                    <!--begin::Heading-->
                                    <h1 class="text-dark fw-bolder my-1 fs-3 lh-1">Detail History Booking</h1>
                        ...
                        <div class="container-xxl" id="kt_content_container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h2 class="card-title fw-bolder">Booking Name :&nbsp; &nbsp; <span class="bagde badge-light-primary">{{ $bookingEvent->title }}</span> </h2>
                                    <div class="card-toolbar">

                                        <a href="/history-booking" class="btn btn-info btn-sm me-2">
                                        ...
                                        <button class="btn btn-secondary btn-sm me-2" onClick="window.location.reload();">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @foreach($bookingEvent->participant as $participant)
                                        <div class="col-xl-4 col-sm-12">
                                            ...
                                            <div class="alert alert-dismissible bg-light-primary border border-primary d-flex flex-column flex-sm-row p-5 mb-10">
                                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                                    <h4 class="mb-1">{{ $participant->email }}</h4>
                                                </div>
